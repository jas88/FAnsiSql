...
/// <summary>
/// Query provider for listing PostgreSQL tables with server-side filtering.
/// </summary>
public sealed class PostgreSqlTableQueryProvider : IQueryProvider
{
    ...
    public PostgreSqlTableQueryProvider(
