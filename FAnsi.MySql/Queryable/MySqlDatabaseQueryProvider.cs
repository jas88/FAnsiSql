...
/// <summary>
/// Query provider for listing MySQL databases with server-side filtering.
/// </summary>
public sealed class MySqlDatabaseQueryProvider : IQueryProvider
{
    private readonly MySqlQueryBuilder _queryBuilder;
    private readonly DbConnection _connection;

    public MySqlDatabaseQueryProvider(
    ...
    public object Execute(Expression expression)
    {
        ...
        while (reader.Read())
        {
            var databaseName = reader["SCHEMA_NAME"] as string;
