...
{
    /// <summary>
    ///     Sets an <see cref="DataColumn.ExtendedProperties" /> on all string columns of <paramref name="dt" /> to indicate to
    ///     FAnsi
    ///     that it should not attempt to change the Type of the string columns e.g. when creating a table.
    ///     <para>
    ///         Method has no effect on columns where the <see cref="DataColumn.DataType" /> is not <see cref="string" />
    ///     </para>
    /// </summary>
    /// <param name="dt"></param>
