...
/// <summary>
///     For use with <see cref="ConnectionStringKeywordAccumulator" />, allows different parts of of your codebase to
...
{
    /// <summary>
    ///     Lowest priority e.g. settings defined in app config / global const parameters etc that you are happy to be
    ///     overriden elsewhere
    /// </summary>
    SystemDefaultLow,
    ...
    /// <summary>
    ///     High level priority, the C# object being used is specifying a required keyword for it to operate correctly.  This
    ///     overrides
