...
public static class StringComparisonHelper
{
    ...
    public static bool EqualsInvariantCultureIgnoreCase(ReadOnlySpan<char> span1, ReadOnlySpan<char> span2) =>
        span1.Equals(span2, StringComparison.InvariantCultureIgnoreCase);
    ...
    public static bool EqualsCurrentCultureIgnoreCase(ReadOnlySpan<char> span1, ReadOnlySpan<char> span2) =>
        span1.Equals(span2, StringComparison.CurrentCultureIgnoreCase);
    ...
    public static bool ContainsInvariantCultureIgnoreCase(ReadOnlySpan<char> span, ReadOnlySpan<char> value) =>
        span.Contains(value, StringComparison.InvariantCultureIgnoreCase);
    ...
    public static bool ContainsCurrentCultureIgnoreCase(ReadOnlySpan<char> span, ReadOnlySpan<char> value) =>
        span.Contains(value, StringComparison.CurrentCultureIgnoreCase);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool ColumnNamesEqual(string columnName1, string columnName2) => columnName1.AsSpan()
        .Equals(columnName2.AsSpan(), StringComparison.CurrentCultureIgnoreCase);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool DatabaseObjectNamesEqual(string objectName1, string objectName2) => objectName1.AsSpan()
        .Equals(objectName2.AsSpan(), StringComparison.InvariantCultureIgnoreCase);
    ...
    public static bool SqlTypesEqual(string sqlType1, string sqlType2) =>
        sqlType1.AsSpan().Equals(sqlType2.AsSpan(), StringComparison.OrdinalIgnoreCase);
    ...
    public static bool SqlTypeContains(string sqlType, string pattern) =>
        sqlType.AsSpan().Contains(pattern.AsSpan(), StringComparison.OrdinalIgnoreCase);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool RuntimeNamesEqual(string runtimeName1, string runtimeName2,
        StringComparison comparisonType = StringComparison.CurrentCultureIgnoreCase) =>
        runtimeName1.AsSpan().Equals(runtimeName2.AsSpan(), comparisonType);
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool RuntimeNameEqualsAny(string runtimeName, ReadOnlySpan<string> candidates,
        StringComparison comparisonType = StringComparison.CurrentCultureIgnoreCase)
    {
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool RuntimeNameContains(string runtimeName, string pattern,
        StringComparison comparisonType = StringComparison.OrdinalIgnoreCase) =>
        runtimeName.AsSpan().Contains(pattern.AsSpan(), comparisonType);
}
