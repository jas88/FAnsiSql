...
public interface IDiscoveredServerHelper
{
    ...
    /// <summary>
    ///     Returns a new connection string builder with the supplied parameters.  Note that if a concept is not supported in
    ///     the
    ///     <see cref="DbConnectionStringBuilder" /> implementation then the value will not appear in the connection string
    ///     (e.g. Oracle
    ...
    /// <param name="username">
    ///     Optional username to set in connection string (otherwise integrated security will be used - if
    ///     supported)
    /// </param>
    /// <param name="password">
    ///     Optional password to set in connection string (otherwise integrated security will be used - if
    ///     supported)
    /// </param>
    /// <returns></returns>
    DbConnectionStringBuilder GetConnectionStringBuilder(string server, string? database, string username,
        string password);
