...
internal abstract class TableHelperColumnOperationTestsBase : DatabaseTests
{
    ...
    protected void AddColumn_StringColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void AddColumn_NotNullColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void AddColumn_DateTimeColumn_Success(DatabaseType type)
    {
    ...
    protected void AddColumn_DecimalColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void AddColumn_MultipleColumns_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void DropColumn_ExistingColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void DropColumn_WithData_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void DropColumn_NonPrimaryKeyColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void DropColumn_LastNonKeyColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void DiscoverColumn_AfterAddColumn_FindsNewColumn(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void DiscoverColumn_CaseInsensitive_FindsColumn(DatabaseType type)
    {
        var db = GetTestDatabase(type);
