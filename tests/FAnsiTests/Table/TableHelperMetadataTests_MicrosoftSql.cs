...
internal sealed class TableHelperMetadataTests_MicrosoftSql : TableHelperMetadataTestsBase
{
    ...
    [Test]
    public void HasPrimaryKey_CompositePrimaryKey_ReturnsTrue() =>
        HasPrimaryKey_CompositePrimaryKey_ReturnsTrue(DbType);

    [Test]
    public void HasPrimaryKey_AfterAddingPrimaryKey_ReturnsTrue() =>
        HasPrimaryKey_AfterAddingPrimaryKey_ReturnsTrue(DbType);
    ...
    [Test]
    public void DiscoverRelationships_NoRelationships_ReturnsEmpty() =>
        DiscoverRelationships_NoRelationships_ReturnsEmpty(DbType);

    [Test]
    public void DiscoverRelationships_WithForeignKey_ReturnsRelationship() =>
        DiscoverRelationships_WithForeignKey_ReturnsRelationship(DbType);

    [Test]
    public void ScriptTableCreation_ReturnsValidSql() => ScriptTableCreation_ReturnsValidSql(DbType);

    [Test]
    public void ScriptTableCreation_DropPrimaryKeys_OmitsPrimaryKey() =>
        ScriptTableCreation_DropPrimaryKeys_OmitsPrimaryKey(DbType);

    [Test]
    public void MakeDistinct_TableWithDuplicates_RemovesDuplicates() =>
        MakeDistinct_TableWithDuplicates_RemovesDuplicates(DbType);
