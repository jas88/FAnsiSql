...
internal abstract class ManagedConnectionTestsBase : DatabaseTests
{
    protected abstract DatabaseType DatabaseType { get; }

    protected void Test_GetConnection_NotOpenAtStart()
    {
    ...
    protected void Test_ManagedTransaction_MultipleCancel()
    {
        var db = GetTestDatabase(DatabaseType);
