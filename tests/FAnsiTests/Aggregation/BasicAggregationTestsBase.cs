...
internal abstract class BasicAggregationTestsBase : AggregationTests
{
    protected void Test_BasicCount(DatabaseType type)
    {
    ...
    protected void Test_GroupByCount(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
