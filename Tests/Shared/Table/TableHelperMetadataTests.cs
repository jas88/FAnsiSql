...
/// </summary>
internal sealed class TableHelperMetadataTests : DatabaseTests
{
    #region HasPrimaryKey Tests

    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void HasPrimaryKey_NoPrimaryKey_ReturnsFalse(DatabaseType type)
    {
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void HasPrimaryKey_WithPrimaryKey_ReturnsTrue(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void HasPrimaryKey_CompositePrimaryKey_ReturnsTrue(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void DiscoverColumns_EmptyTable_ReturnsColumns(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void DiscoverColumns_IdentifiesPrimaryKey(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void DiscoverColumns_IdentifiesAutoIncrement(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void DiscoverColumns_IdentifiesNullability(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void DiscoverColumns_CorrectDataTypes(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void DiscoverRelationships_NoRelationships_ReturnsEmpty(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void ScriptTableCreation_ReturnsValidSql(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void ScriptTableCreation_DropPrimaryKeys_OmitsPrimaryKey(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void MakeDistinct_TableWithDuplicates_RemovesDuplicates(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void MakeDistinct_TableWithPrimaryKey_NoChange(DatabaseType type)
    {
        var db = GetTestDatabase(type);
