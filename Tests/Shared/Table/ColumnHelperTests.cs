...
/// <summary>
/// Tests ColumnHelper operations: GetTopXSqlForColumn and GetAlterColumnToSql.
...
/// </summary>
internal sealed class ColumnHelperTests : DatabaseTests
{
    #region GetTopXSqlForColumn Tests

    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_WithoutDiscardNulls_ReturnsAllRows(DatabaseType type)
    {
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_WithDiscardNulls_ExcludesNulls(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_IntegerColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_DateTimeColumn_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_SingleRow_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_AllNulls_WithDiscardNulls_ReturnsEmpty(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_LargeTopX_ReturnsAllAvailable(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_SpecialCharactersInColumnName_Success(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    {
        var db = GetTestDatabase(DatabaseType.Sqlite);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_ContainsDatabaseSpecificSyntax(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void GetTopXSqlForColumn_UsesInvariantCulture(DatabaseType type)
    {
        var db = GetTestDatabase(type);
