...
internal sealed class AggregateHelperCoreTests : AggregationTests
{
    ...
    public void Test_GetDatePartOfColumn_Day(DatabaseType type)
    {
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_GetDatePartOfColumn_Month(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var helper = (AggregateHelper)tbl.Database.Server.GetQuerySyntaxHelper().AggregateHelper;
        var eventDateCol = tbl.DiscoverColumn("EventDate");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_GetDatePartOfColumn_Year(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var helper = (AggregateHelper)tbl.Database.Server.GetQuerySyntaxHelper().AggregateHelper;
        var eventDateCol = tbl.DiscoverColumn("EventDate");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_GetDatePartOfColumn_Quarter(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var helper = (AggregateHelper)tbl.Database.Server.GetQuerySyntaxHelper().AggregateHelper;
        var eventDateCol = tbl.DiscoverColumn("EventDate");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_SumAggregate(DatabaseType type)
    {
        var tbl = GetTestTable(type);
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_AvgAggregate(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var numberCol = tbl.DiscoverColumn("NumberInTrouble");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_MinAggregate(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var numberCol = tbl.DiscoverColumn("NumberInTrouble");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_MaxAggregate(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var numberCol = tbl.DiscoverColumn("NumberInTrouble");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_GroupByWithSum(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_GroupByWithAvg(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_CountDistinct(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_HavingClause_GreaterThan(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_HavingClause_Count(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_CustomAggregateAlias(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var numberCol = tbl.DiscoverColumn("NumberInTrouble");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_MultipleGroupByColumns(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_WhereClauseWithAggregate(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
    ...
    [TestCaseSource(typeof(All), nameof(All.DatabaseTypes))]
    public void Test_WhereAndGroupBy(DatabaseType type)
    {
        var tbl = GetTestTable(type);
        var svr = tbl.Database.Server;
        var category = tbl.DiscoverColumn("Category");
