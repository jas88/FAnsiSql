...
/// <summary>
/// Oracle tests that run in parallel with other database type fixtures.
/// Tests within this fixture run sequentially on a single connection.
/// Oracle DDL causes implicit commits, so tables are tracked and explicitly dropped.
/// </summary>
[TestFixture]
[Parallelizable(ParallelScope.Self)]
public sealed class OracleParallelTests : SharedDatabaseTests
{
    ...
    public void InsertAndSelect_Data()
    {
        ...
        {
            var count = (int)(decimal)select.ExecuteScalar()!; // Oracle returns decimal for COUNT(*)
