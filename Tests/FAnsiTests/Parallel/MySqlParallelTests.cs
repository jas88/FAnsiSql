...
/// <summary>
/// MySQL tests that run in parallel with other database type fixtures.
/// Tests within this fixture run sequentially on a single connection.
/// </summary>
[TestFixture]
[Parallelizable(ParallelScope.Self)]
public sealed class MySqlParallelTests : SharedDatabaseTests
{
    ...
    public void InsertAndSelect_Data()
    {
        ...
        {
            var count = (int)(long)select.ExecuteScalar()!; // MySQL returns long for COUNT(*)
