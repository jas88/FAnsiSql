...
/// <summary>
/// SQL Server tests that run in parallel with other database type fixtures.
/// Tests within this fixture run sequentially on a single connection.
/// </summary>
[TestFixture]
[Parallelizable(ParallelScope.Self)]
public sealed class SqlServerParallelTests : SharedDatabaseTests
{
    ...
    public void InsertAndSelect_Data()
    {
        ...
        {
            var count = (int)select.ExecuteScalar()!;
