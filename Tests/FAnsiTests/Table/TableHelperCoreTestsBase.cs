...
internal abstract class TableHelperCoreTestsBase : DatabaseTests
{
    ...
    protected void Exists_TableDoesNotExist_ReturnsFalse(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Exists_AfterDrop_ReturnsFalse(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Exists_CaseInsensitive_ReturnsTrue(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Exists_WithSchema_ReturnsTrue(DatabaseType type)
    {
    ...
    protected void Drop_TableExists_SuccessfullyDrops(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Drop_TableWithData_SuccessfullyDrops(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Drop_View_SuccessfullyDrops(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Truncate_TableWithData_RemovesAllRows(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    protected void Truncate_EmptyTable_NoError(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void Truncate_PreservesTableStructure(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void GetRowCount_EmptyTable_ReturnsZero(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void GetRowCount_TableWithRows_ReturnsCorrectCount(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
        dt.Columns.Add("Id", typeof(int));
    ...
    protected void GetRowCount_AfterInsert_ReturnsUpdatedCount(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void IsEmpty_EmptyTable_ReturnsTrue(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void IsEmpty_TableWithData_ReturnsFalse(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void IsEmpty_AfterTruncate_ReturnsTrue(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void FillDataTableWithTopX_ReturnsCorrectRowCount(DatabaseType type)
    {
        var db = GetTestDatabase(type);
    ...
    protected void FillDataTableWithTopX_PreservesColumnTypes(DatabaseType type)
    {
        var db = GetTestDatabase(type);
        using var dt = new DataTable();
