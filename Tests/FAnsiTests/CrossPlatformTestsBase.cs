    ...
    */
    ...
    protected void CreateTable_EmptyDataTable_ExplicitTypes()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(syntaxHelper.TypeTranslater.GetCSharpTypeForSQLDBType(dateCol.DataType?.SQLType), Is.EqualTo(DatabaseType == DatabaseType.Sqlite ? typeof(string) : typeof(DateTime)));
